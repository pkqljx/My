...
import com.example.a4.bean.UserInfo;
import com.example.a4.database.UserDBHelper;
import com.example.a4.util.DateUtil;
import com.example.a4.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990098-李佳欣"};
